...
import { AnyObject } from '#types/basicObjects';
import { StateProviderProps } from '#types/stateProvider';
 ...
 */
export default <TComponentProps extends AnyObject>(
  hydratableComponents: Record<string, FC<TComponentProps>>,
  StateProvider: FC<StateProviderProps>,
) => {
