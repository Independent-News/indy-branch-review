...
const createBookmarkItem = (bookmark: Bookmark) => {
  ...
  const links =
    ...
    [];
  const thumbnail = bookmarkWrapper?.querySelector('.poster img');
  const title = bookmarkWrapper?.querySelector('.title');
  const lead = bookmarkWrapper?.querySelector('.lead');
  const published = bookmarkWrapper?.querySelector('.published');
  const authors = bookmarkWrapper?.querySelector('.authors');
  const section = bookmarkWrapper?.querySelector('.section');
  const removeButton = bookmarkWrapper?.querySelector('.remove');
