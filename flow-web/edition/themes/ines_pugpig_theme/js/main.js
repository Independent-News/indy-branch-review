!(function (a, b) {
      ...
      c &&
        ...
        ((b =
          c[Nd] < 0 || c[Nd] > 11
            ...
            ? Sd
            : -1),
        j(a)._overflowDayOfYear && (b < Md || b > Od) && (b = Od),
  ...
  function na(a) {
    ...
    if (i) {
      for (j(a).iso = !0, b = 0, c = be.length; b < c; b++)
        if (be[b][1].exec(i[1])) {
          (e = be[b][0]), (d = be[b][2] !== !1);
          break;
        }
  ...
  function cd(a, b) {
    return void 0 !== af[a] && (void 0 === b ? af[a] : ((af[a] = b), !0));
  }
  function dd(a) {
    ...
    (K < 2 || (2 === K && L < 6)) &&
      ...
      (j.prototype.scoreOffsetAt = function (a) {
        (this.offsetScore += Math.abs(this.zone.offset(a.at) - a.offset)),
          this.zone.abbr(a.at).match(/[A-Z]/g).join('') !== a.abbr &&
            this.abbrScore++;
      }),
      (A.version = E),
      (A.dataVersion = ''),
  ...
  !(function () {
    ...
    function b(a, b) {
      (a.onload = function () {
        (a.onload = null), b && b.call(a);
      }),
        'isApplicationInstalled' in navigator &&
          'onloadcssdefined' in a &&
          a.onloadcssdefined(b);
    }
    !(function (c) {
      var d = function (e, f) {
        'use strict';
        if (e && 3 === e.length) {
          var g = c.navigator,
            ...
            j = !(
              ...
              (c.opera && g.userAgent.indexOf('Chrome') === -1) ||
              g.userAgent.indexOf('Series40') !== -1
            ),
            k = new i();
          (k.onerror = function () {
            (d.method = 'png'), (d.href = e[2]), a(e[2]);
          }),
            (k.onload = function () {
      ...
      (d.loadCSS = a), (d.onloadCSS = b), (c.grunticon = d);
    })(this),
      (function (a, b) {
        'use strict';
        var c,
          ...
          h = function (a, b) {
            ...
            c = {};
            var d, f, g, h, i, j;
            if (((d = a.sheet), !d)) return c;
            f = d.cssRules ? d.cssRules : d.rules;
            for (var k = 0; k < f.length; k++)
              (g = f[k].cssText),
                (h = e + f[k].selectorText),
                (i = g.split(');')[0].match(/US\-ASCII\,([^"']+)/)),
                i && i[1] && ((j = decodeURIComponent(i[1])), (c[h] = j));
            return c;
          },
          i = function (a, b) {
            var c, f, g, h, i;
            b ? (c = a) : ((b = a), (c = d)), (h = 'data-grunticon-embed');
            for (var j in b) {
              i = j.slice(e.length);
              try {
              ...
              for (var l = 0; l < f.length; l++)
                null !== f[l].getAttribute(h) && g.push(f[l]);
              if (g.length)
                for (l = 0; l < g.length; l++)
                  (g[l].innerHTML = b[j]),
                    (g[l].style.backgroundImage = 'none'),
                    g[l].removeAttribute(h);
            }
            return g;
          },
          j = function (b, c) {
        ...
        (a.embedIcons = i),
          ...
          (a.getIcons = h),
          (a.ready = f),
          (a.svgLoadedCallback = j),
          (a.embedSVG = j);
      })(grunticon, this);
  })(),
  (function (a) {
    function b(b, c) {
      a('.programme-list .programme').each(function (d, e) {
        var f = moment(a(this).data('prog-start-time'));
        f.toDate();
        var g = f.clone();
        if (
          (g.add(a(this).data('prog-duration'), 'minutes'),
          g.toDate(),
          a(this).removeClass('starts-earlier'),
          a(this).removeClass('finishes-later'),
          a(this).removeClass('hidden'),
          g <= b || f >= c)
        )
          a(this).addClass('hidden'), a(this).removeAttr('style');
        else {
          var h = a(this).data('prog-duration'),
            i = a('#tv-listings').attr('data-duration-shown');
          if (f < b) {
            var j = Math.floor((b - f) / 1e3 / 60);
            (h -= j), a(this).addClass('starts-earlier');
          }
          if (g > c) {
            var k = Math.floor((g - c) / 1e3 / 60);
            (h -= k), a(this).addClass('finishes-later');
          }
          var l = (h / i) * 100 + '%';
          a(this).width(l);
        }
    ...
    function c(b) {
      var c = new Date(b.getTime() + 18e5),
        d = new Date(b.getTime() + 36e5),
        e = moment.tz(b, 'Europe/London').format('HH.mm'),
        f = moment.tz(c, 'Europe/London').format('HH.mm'),
        g = moment.tz(d, 'Europe/London').format('HH.mm'),
        h = new Date(),
        i = Math.floor((h - b) / 6e4);
      i > 0 && i < 30 ? a('#time1').html('Now') : a('#time1').html(e),
        a('#time2').html(f),
        a('#time3').html(g);
    }
    function d() {
      var d = (new Date(), 45);
      a('#tv-listings').addClass('tv-listings-small'),
        a('#tv-listings').attr('data-duration-shown', d);
      var e = new Date(a('#tv-listings').attr('data-display-start-time')),
        f = new Date(e.getTime() + 6e4 * d);
      moment(f).isValid() &&
        a('#tv-listings').attr('data-display-end-time', f.toISOString()),
        c(e),
        b(e, f);
    }
    function e() {
      var d = (new Date(), 90);
      a('#tv-listings').removeClass('tv-listings-small'),
        a('#tv-listings').attr('data-duration-shown', d);
      var e = new Date(a('#tv-listings').attr('data-display-start-time')),
        f = new Date(e.getTime() + 6e4 * d);
      moment(f).isValid() &&
    ...
    a(document).ready(function () {
      var d = new Date();
      (d = moment.tz(d, 'Europe/London')),
        (d =
          d.minutes() < 30
            ? d.startOf('hour').toDate()
            : d.minutes(30).seconds(0).milliseconds(0).toDate());
      var e;
      a(window).width() < 500
        ? ((e = 45),
          a('#tv-listings').addClass('tv-listings-small'),
          a('#tv-listings').attr('data-duration-shown', e))
        : ((e = 90), a('#tv-listings').attr('data-duration-shown', e));
      var f = new Date(a('#tv-listings').data('tv-listings-date'));
      (f = moment.tz(f, 'Europe/London')), (f = f.hours(6).toDate());
      var g = new Date(a('#tv-listings').data('tv-listings-date'));
      (g = moment.tz(g, 'Europe/London')), (g = g.add(1, 'day').toDate());
      var h;
      d < f
        ? ((h = f), a('#earlier-programmes').addClass('disabled'))
        : d > g
        ? ((h = f),
          (h = moment.tz(h, 'Europe/London')),
          (h = h.hours(18).toDate()))
        : (h = d);
      var i = new Date(h.getTime() + 6e4 * e);
      moment(h).isValid() &&
        a('#tv-listings').attr('data-display-start-time', h.toISOString()),
        moment(i).isValid() &&
          a('#tv-listings').attr('data-display-end-time', i.toISOString()),
        c(h),
        b(h, i);
    });
    var f;
    a(window).on('resize', function () {
      clearTimeout(f),
        (f = setTimeout(function () {
          a(window).width() < 500 ? d() : e();
        }, 250));
    }),
      $(document).on('click', '#earlier-programmes', function (d) {
        d.preventDefault();
        var e = a('#tv-listings').attr('data-duration-shown');
        a('#later-programmes').removeClass('disabled');
        var f = new Date(a('#tv-listings').attr('data-display-start-time')),
          g = new Date(a('#tv-listings').attr('data-display-end-time')),
          h = new Date(a('#tv-listings').data('tv-listings-date'));
        (h = moment.tz(h, 'Europe/London')), (h = h.hours(6).toDate());
        var i;
        i = f - h < 6e4 * e ? f - h : 6e4 * e;
        var j = new Date(f.getTime() - i),
          k = new Date(g.getTime() - i);
        j <= h && a('#earlier-programmes').addClass('disabled'),
          a('#tv-listings').attr('data-display-start-time', j.toISOString()),
          a('#tv-listings').attr('data-display-end-time', k.toISOString()),
          c(j),
          b(j, k);
      }),
      $(document).on('click', '#later-programmes', function (d) {
        d.preventDefault();
        var e = a('#tv-listings').attr('data-duration-shown');
        a('#earlier-programmes').removeClass('disabled');
        var f = new Date(a('#tv-listings').attr('data-display-start-time')),
          g = new Date(a('#tv-listings').attr('data-display-end-time')),
          h = new Date(a('#tv-listings').data('tv-listings-date'));
        (h = moment.tz(h, 'Europe/London')), (h = h.add(1, 'day').toDate());
        var i;
        i = h - g < 6e4 * e ? h - g : 6e4 * e;
        var j = new Date(f.getTime() + i),
          k = new Date(g.getTime() + i);
        k >= h && a('#later-programmes').addClass('disabled'),
          a('#tv-listings').attr('data-display-start-time', j.toISOString()),
          a('#tv-listings').attr('data-display-end-time', k.toISOString()),
          c(j),
          b(j, k);
      ...
      $(document).on(
        'click',
        '.programme:not(.pop-up-open, .off-air)',
        function (b) {
          b.preventDefault(),
            a('.pop-up-detail').remove(),
            a('.programme').removeClass('pop-up-open');
          var c = a(this).position(),
            d = a(this).offset(),
            e = c.left,
            f = a(this).width(),
            g = a(this).find('.title').first().text(),
            h = a(this).find('.description').first().text();
          f < 100 && (f = 100),
            e + f > a('#tv-listings').width() - 8 &&
              (e = a('#tv-listings').width() - f - 8);
          var i = '';
          d.top + 115 > a('body').height() && (i += 'fixed-bottom'),
            a(this).addClass('pop-up-open'),
            a(this).append(
              '<div class="pop-up-detail ' +
                ...
                'px; width: ' +
                f +
                'px;"><a href="#" class="pop-up-close">X</a><div class="popup-title">' +
                g +
                '</div><div class="popup-description">' +
                h +
                '</div></div>',
            );
        },
      ),
      $(document).on('click', '.pop-up-close', function (b) {
        b.preventDefault(),
          a(this).parent('.pop-up-detail').remove(),
          a('.programme').removeClass('pop-up-open');
      });
  })(jQuery),
  (function (a) {
    grunticon(
      [
        '../themes/ines_pugpig_theme/icons/icons.data.svg.css',
        '../themes/ines_pugpig_theme/icons/icons.data.png.css',
        '../themes/ines_pugpig_theme/icons/icons.fallback.css',
      ],
