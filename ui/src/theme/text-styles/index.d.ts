...
export declare const base: {
    ...
    supportNSC: {
        ...
        copy: {
            lineHeight: number;
            font: import('styled-components').RuleSet<object>;
        };
    ...
    newsletterPreferences: {
        ...
        loggedOutForm: {
            dropdownTrigger: import('styled-components').RuleSet<object>;
            checkboxLabel: string;
        };
    };
    sponsoredNSC: {
    ...
    AuthorHighlight: {
        ...
        byline: {
            name: import('styled-components').RuleSet<object>;
            bio: import('styled-components').RuleSet<object>;
        };
    };
};
