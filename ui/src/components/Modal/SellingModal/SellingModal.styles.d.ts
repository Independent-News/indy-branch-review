...
export declare const CloseIconButton: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('../../IconButton/IconButton.types').CommonButtonProps & import('../../Icon').IconProps & {
    title?: string;
    isCosy?: boolean;
    isDisabled?: boolean;
    onClick?: () => void;
}, never>> & string & Omit<({ title, svg, size, isCosy, isDisabled, ...rest }: import('../../IconButton').IconButtonProps) => import("react/jsx-runtime").JSX.Element, keyof import('react').Component<any, {}, any>>;
...
//# sourceMappingURL=SellingModal.styles.d.ts.map