...
export declare const ErrorIcon: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('../../Icon').IconProps, never>> & string & Omit<{
