...
export declare const StyledIcon: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('../Icon').IconProps, never>> & string & Omit<import('react').FC<import('../Icon').IconProps>, keyof import('react').Component<any, {}, any>>;
