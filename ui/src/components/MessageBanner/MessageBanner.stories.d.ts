...
declare const _default: {
    title: string;
    component: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<BaseProps, never>> & string & Omit<import('react').FC<BaseProps>, keyof import('react').Component<any, {}, any>>;
    argTypes: {
        messageTimeout: {
            description: string;
            control: {
