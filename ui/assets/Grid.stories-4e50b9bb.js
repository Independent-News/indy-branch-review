...
one or more <Column />.`,...(y=(g=l.parameters)==null?void 0:g.docs)==null?void 0:y.description}}};var G,R,T,_,k;i.parameters={...i.parameters,docs:{...(G=i.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: _props => {
    const Column = withContent(GridColumn);
    return <Grid>
        <Row>
...
device.`,...(k=(_=i.parameters)==null?void 0:_.docs)==null?void 0:k.description}}};var q,v,O,S,L;a.parameters={...a.parameters,docs:{...(q=a.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: _props => {
    const Column = withContent(GridColumn);
    return <Grid>
        <Row>
...
}`,...(O=(v=a.parameters)==null?void 0:v.docs)==null?void 0:O.source},description:{story:"Columns can be offset within the `<Grid />`. This is done by passing a config\nobject via the `offset` prop.\n\nBear in mind that it is possible to offset a column by more than the maximum\nnumber of columns for the `<Grid />`, therefore pushing it onto a new row.",...(L=(S=a.parameters)==null?void 0:S.docs)==null?void 0:L.description}}};var I,W,E,F,A;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: _props => <Grid>
      <Row>
        <Column span={{
        mobile: 4,
