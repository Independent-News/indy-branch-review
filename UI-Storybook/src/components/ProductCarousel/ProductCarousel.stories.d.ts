...
declare const _default: {
    title: string;
    component: ({ fetchPrice, initialIndex, isComparison, livePrices, products, selectedItemIDs, title, offsetKey, onToggleSelectedProduct, onBuyNowClick, onReadReviewClick, }: ProductCarouselProps) => import("react/jsx-runtime").JSX.Element;
