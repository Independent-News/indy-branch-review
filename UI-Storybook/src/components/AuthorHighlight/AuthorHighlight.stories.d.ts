...
export declare const TertiaryWithoutImage: {
    args: AuthorHighlightProps;
    render: (args: AuthorHighlightProps) => import("react/jsx-runtime").JSX.Element;
};
export declare const TertiaryWithoutBio: {
    args: AuthorHighlightProps;
    render: (args: AuthorHighlightProps) => import("react/jsx-runtime").JSX.Element;
};
export declare const TertiaryWithoutImageOrBio: {
    args: AuthorHighlightProps;
    render: (args: AuthorHighlightProps) => import("react/jsx-runtime").JSX.Element;
};
export declare const TertiaryWithMultipleAuthors: {
    args: AuthorHighlightProps;
    render: (args: AuthorHighlightProps) => import("react/jsx-runtime").JSX.Element;
};
export declare const TertiaryWithMultipleAuthorsWithoutBio: {
    args: AuthorHighlightProps;
    render: (args: AuthorHighlightProps) => import("react/jsx-runtime").JSX.Element;
};
